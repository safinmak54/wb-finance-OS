 ...
 * generated `checksum` column (migrations 0016 + 0017). Used to drop duplicate
 * rows from a multi-row insert payload BEFORE it hits the DB, since a
 * single `insert ... on conflict do nothing` statement can still collide
 ...
 * amount rounding in sync with the generated column.
 */
